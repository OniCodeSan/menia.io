    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {currentUser ? (
            <Link to={currentUser.role === 'creator' || currentUser.role === 'admin' ? '/dashboard' : '/fan-dashboard'} className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-secondary/60 hover:bg-secondary transition-all border border-border/40">
