        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground leading-relaxed max-w-xs">
              La piattaforma per creator che vogliono monetizzare la propria community con abbonamenti e contenuti esclusivi.
            </p>
          </div>

          {/* Piattaforma */}
          <div>
            <h4 className="font-heading font-bold text-sm mb-3">Piattaforma</h4>
            <div className="space-y-2 text-sm text-muted-foreground">
              <Link to="/explore" className="block hover:text-foreground transition-colors">Esplora</Link>
              <Link to="/feed" className="block hover:text-foreground transition-colors">Feed</Link>
              <Link to="/creator-onboarding" className="block hover:text-foreground transition-colors">Diventa Creator</Link>
            </div>
          </div>

          {/* Legale */}
          <div>
            <h4 className="font-heading font-bold text-sm mb-3">Legale</h4>
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <Link to="/support" className="block hover:text-foreground transition-colors">{f.support}</Link>
              <Link to="/cookie-policy" className="block hover:text-foreground transition-colors">Cookie Policy</Link>
              <button onClick={openCookieSettings} className="block text-left hover:text-foreground transition-colors">Impostazioni cookie</button>
            </div>
          </div>

          {/* Social */}
          <div>
            <h4 className="font-heading font-bold text-sm mb-3">Seguici</h4>
