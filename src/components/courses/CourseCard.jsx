  ...
  return (
    ...
    >
      <Link
        ...
        className="block bg-card border border-border/30 rounded-2xl overflow-hidden hover:border-primary/40 transition-colors h-full"
      >
        <div className="aspect-[16/9] relative overflow-hidden">
          {course.cover_url ? (
            <img src={course.cover_url} alt="" className="w-full h-full object-cover" loading="lazy" />
          ) : (
            // Fallback non-grigio: gradient brand + titolo overlay. Trasmette
            // "corso reale" anche senza cover image.
            <div className="w-full h-full bg-gradient-to-br from-primary via-primary/70 to-accent/80 flex items-end p-4 relative">
