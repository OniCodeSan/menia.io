...
export default function FanLogin() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setSubmitting(true);
    base44.auth.redirectToLogin("/fan-dashboard");
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-3xl font-bold mb-2">Accedi come Fan</h1>
        ...
        <div className="mt-6 text-center space-y-2">
          <p className="text-xs text-muted-foreground">
            Non hai un account?{" "}
            <Link to="/fan-portal" className="text-accent hover:underline font-medium">
              Registrati
            </Link>
          </p>
          <p className="text-xs text-muted-foreground">
