                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        title={c.notify ? "Disattiva notifiche" : "Attiva notifiche"}
                      >
                    ...
                    <div className="flex items-center justify-between mt-3 pt-3 border-t border-border/20">
                      <div className="flex items-center gap-1.5">
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${c.planBg} ${c.planColor}`}>
                          {c.plan}
                        </span>
                      ...
                      <Link to="/feed">
                        <Button size="sm" variant="outline" className="h-7 text-xs border-border/50 px-3">
                          Vai al profilo
                        </Button>
                      </Link>
                    </div>
