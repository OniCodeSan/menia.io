    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <StatCard
            title="Fan Attivi"
            value={dashboardData.activeFans.toLocaleString()}
            trend={dashboardData.fansTrend}
            icon={Users}
            delay={0.05}
          />
          <StatCard
          ...
          />
          <StatCard
            title="Nuovi Abbonati"
            value={dashboardData.newSubs}
            trend={dashboardData.newSubsTrend}
            icon={UserPlus}
            delay={0.15}
          />
        </div>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  ...
                  { icon: Calendar, label: "Programma post", color: "text-chart-3" },
